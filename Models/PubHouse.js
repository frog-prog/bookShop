...
class PubHouse extends client_1.PrismaClient {
    findManyById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.pubHouse.findMany({
                where: {
                    id: id
                }
            });
